...
module.exports.run = async function ({ api, event, args }) {
    ...
    if (!searchQuery) {
        return api.sendMessage("❗ Kripya lyrics search karne ke liye song ka naam provide kare. Usage: `+lyrics [song name]`", threadID, messageID);
    }
    ...
    try {
        ...
        api.sendMessage(`🚫 Lyrics fetch karne me error aagya. Kripya song ka naam sahi se likhe ya server check kare! Error: ${err.message}`, threadID, messageID);
    } finally {
